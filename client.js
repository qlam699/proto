...
var client = new proto.FileInfoService(
  'localhost:50051',
  grpc.credentials.createInsecure()
);

function getFileInfos() {
  client.getFileInfos('point1', (err, response) => {
    console.log('errors: ', err);
    console.log('getFileInfos: ', response.fileinfos);
  });
}
...
function createFileInfo() {
  ...
  client.createFileInfo(finew, (err, data) => {
    if (err) throw err;
